...
{
    // prover validação atravez do backend
    ...
    // prover validação atravez do frontend
    public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaAttribute>
    {
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-moeda", GetErrorMessage(context)); // não necessário em outros idiomas
    ...
    // prover validação atravez do aspnet
