...
namespace AppSemTemplate.Extensions
{
    ...
    public class BotaoTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            // scheme -> tipo do protocolo http, https, depois do :// é o value do host    
            ...
            output.TagName = "a";
            output.Attributes.SetAttribute("href", $"{host}{indexPath}"); // a url é gerada pelo proprio razor e adicionada ao link
