...
namespace PrimeiroApp.Controllers
{
    public class AlunosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] // cria uma camada de segurança contra ataques de envio de formulario xss
        public async Task<IActionResult> Create([Bind("Id, Nome, DataNascimento, Email, EmailConfirmacao, Avaliacao, Ativo")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(Index)); // reencaminha para a action Index
            }
